...
var (
	...
	ErrRecuperarCoinInformada = errors.New("erro ao recuperar a moeda informada")
	ErrUnmarshalCoinInformada = errors.New("erro ao fazer o Unmarshal da moeda informada")
)
